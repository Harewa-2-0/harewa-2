...
export default function AddFabricModal({ isOpen, onClose, onSuccess }: AddFabricModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setIsLoading(true);
    try {
      // Only UI scaffold for now
      addToast('Fabric created (UI only).', 'success');
      onSuccess?.();
      onClose();
    } catch (error: any) {
      addToast(error?.message || 'Failed to create fabric.', 'error');
    } finally {
      setIsLoading(false);
    }
  };
          ...
          {step === 1 && (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input id="name" name="name" type="text" value={formData.name} onChange={handleInputChange} placeholder="Cotton Twill" className="w-full px-3 py-2 border border-gray-300 rounded-lg text-gray-900 focus:outline-none focus:ring-2 focus:ring-[#D4AF37] focus:border-[#D4AF37] disabled:bg-gray-50 disabled:cursor-not-allowed" required />
              </div>
              <div>
                <label htmlFor="type" className="block text-sm font-medium text-gray-700 mb-1">Type *</label>
                <input id="type" name="type" type="text" value={formData.type} onChange={handleInputChange} placeholder="Cotton" className="w-full px-3 py-2 border border-gray-300 rounded-lg text-gray-900 focus:outline-none focus:ring-2 focus:ring-[#D4AF37] focus:border-[#D4AF37] disabled:bg-gray-50 disabled:cursor-not-allowed" required />
              </div>
              <div>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <input type="text" name="color" value={formData.color} onChange={handleInputChange} placeholder="Navy Blue" className="flex-1 px-3 py-2 border border-gray-300 rounded-lg text-gray-900 focus:outline-none focus:ring-2 focus:ring-[#D4AF37] focus:border-[#D4AF37]" required />
                </div>
              ...
              <div>
                ...
                <input id="pattern" name="pattern" type="text" value={formData.pattern} onChange={handleInputChange} placeholder="Solid / Striped / Checked" className="w-full px-3 py-2 border border-gray-300 rounded-lg text-gray-900 focus:outline-none focus:ring-2 focus:ring-[#D4AF37] focus:border-[#D4AF37]" required />
              </div>
            </div>
          )}
          ...
          {step === 2 && (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input id="weight" name="weight" type="number" step="1" min="1" value={formData.weight} onChange={handleInputChange} placeholder="220" className="w-full px-3 py-2 border border-gray-300 rounded-lg text-gray-900 focus:outline-none focus:ring-2 focus:ring-[#D4AF37] focus:border-[#D4AF37]" required />
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">Width</label>
                <div className="flex space-x-2">
                  <input id="width" name="width" type="number" step="0.01" min="0.01" value={formData.width} onChange={handleInputChange} placeholder="150" className="flex-1 px-3 py-2 border border-gray-300 rounded-lg text-gray-900 focus:outline-none focus:ring-2 focus:ring-[#D4AF37] focus:border-[#D4AF37]" required />
              ...
              <div className="md:col-span-2">
                ...
                <input id="composition" name="composition" type="text" value={formData.composition} onChange={handleInputChange} placeholder="100% Cotton" className="w-full px-3 py-2 border border-gray-300 rounded-lg text-gray-900 focus:outline-none focus:ring-2 focus:ring-[#D4AF37] focus:border-[#D4AF37]" required />
              </div>
            </div>
          )}
          ...
          {step === 3 && (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input id="supplier" name="supplier" type="text" value={formData.supplier} onChange={handleInputChange} placeholder="Fabric Depot Ltd." className="w-full px-3 py-2 border border-gray-300 rounded-lg text-gray-900 focus:outline-none focus:ring-2 focus:ring-[#D4AF37] focus:border-[#D4AF37]" required />
              </div>
              <div>
                <label htmlFor="pricePerMeter" className="block text-sm font-medium text-gray-700 mb-1">Price per meter (₦)</label>
                <input id="pricePerMeter" name="pricePerMeter" type="number" step="0.01" min="0" value={formData.pricePerMeter} onChange={handleInputChange} placeholder="5999" className="w-full px-3 py-2 border border-gray-300 rounded-lg text-gray-900 focus:outline-none focus:ring-2 focus:ring-[#D4AF37] focus:border-[#D4AF37]" required />
              </div>
            ...
            <div className="flex items-center space-x-3">
              ...
              {step < 4 ? (
                ...
                <button type="submit" disabled={isLoading} className="px-6 py-2 bg-[#D4AF37] text-white text-sm font-medium rounded-lg hover:bg-[#D4AF37]/90 focus:outline-none focus:ring-2 focus:ring-[#D4AF37] transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center space-x-2">
                  ...
                  <span>{isLoading ? 'Creating...' : 'Create Fabric'}</span>
                </button>
              )}
            </div>
          </div>

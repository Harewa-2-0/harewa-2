            ...
            <div className="max-w-2xl px-8 py-16 text-center">
                ...
                <div className="mb-12 flex justify-center">
                    <div className="relative">
                        <div className="w-24 h-24 border-2 border-[#D4AF37] rounded-full animate-ping opacity-20 absolute inset-0" />
                        <div className="w-24 h-24 border-2 border-[#D4AF37] rounded-full flex items-center justify-center bg-[#0a0a0a] relative z-10">
                            <svg
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
                    <div className="bg-[#1a1a1a] p-6 rounded-xl border border-white/5">
                        <span className="block text-sm text-gray-500 uppercase tracking-widest mb-2 font-semibold">
                            Deactivated On
                        </span>
                ...
                <div className="bg-[#D4AF37]/10 p-8 rounded-2xl border border-[#D4AF37]/20 relative overflow-hidden group">
                    ...
                    <p className="text-lg font-medium text-[#D4AF37] mb-4">
                        If you are the owner of this website, please contact your developers immediately.
                    </p>
                    <a
                        href="mailto:harewa2.0@gmail.com"
                        className="inline-flex items-center space-x-3 text-2xl font-bold hover:text-[#D4AF37] transition-colors"
                    >
                        <svg
                            className="w-8 h-8"
                            fill="none"
